...
import {
  ...
  TelegramAdapter,
} from "../../integration/sources/telegram";
...
} from "../../integration/sources/whatsapp";
...
import { LinkedInAdapter } from "@/lib/integration/sources/linkedin";
import { InstagramAdapter } from "@/lib/integration/sources/instagram";
...
import { buildInsightRecord, fetchFeed, getCachedRssBotId } from "../rss";
import { buildRssItemInserts } from "@alloomi/rss";
import {
  listRecentDocuments,
  type GoogleDocSummary,
} from "@/lib/docs/google-docs";
import {
  extractRawMessages,
  type RawMessageData,
} from "@alloomi/indexeddb/extractor";
import { shouldSkipGmailEmail } from "../../email/classifier";
import { FeishuAdapter } from "@/lib/integration/sources/feishu";
...
export async function getInsightsByBotId({
  ...
  try {
    ...
    const generateInsight = async (
      messages: import("./types").InsightInput,
      platform: Platform,
