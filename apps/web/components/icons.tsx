  ...
  return (
    ...
    >
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M11.7803 6.28033L12.3107 5.75L11.25 4.68934L10.7197 5.21967L6.5 9.43935L5.28033 8.21967L4.75001 7.68934L3.68934 8.74999L4.21967 9.28033L5.96967 11.0303C6.11032 11.171 6.30109 11.25 6.5 11.25C6.69891 11.25 6.88968 11.171 7.03033 11.0303L11.7803 6.28033Z"
        fill="currentColor"
      />
    </svg>
  );
  ...
  return (
    ...
    >
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M7.29289 14.6036C7.68342 14.9941 8.31659 14.9941 8.70711 14.6036L13.7803 9.53034L14.3107 8.99999L13.25 7.93934L12.7197 8.46966L8.75 12.4393V1.75V1H7.25V1.75V12.4393L4.28034 8.46966L3.75 7.93934L2.68935 8.99999L3.21968 9.53034L7.29289 14.6036Z"
        fill="currentColor"
      />
    </svg>
  );
...
export const ForwardIcon = ({ size = 16 }: { size?: number }) => {
  return (
    <svg
      height={size}
      strokeLinejoin="round"
    ...
    >
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M10 2H13C13.5523 2 14 2.44772 14 3V13C14 13.5523 13.5523 14 13 14H10V12.5H12.5V4.5H10V2ZM6 8L2 11V5L6 8ZM7 5H8.5V11H7V5Z"
        fill="currentColor"
      />
    </svg>
  );
...
export const FunnelIcon = ({ size = 16 }: { size?: number }) => {
  return (
    <svg
      height={size}
      strokeLinejoin="round"
  ...
  return (
    ...
    >
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M4.854 1.146a.5.5 0 0 0-.708 0l-2.5 2.5a.5.5 0 1 0 .708.708L4 2.707V9.5a.5.5 0 0 0 1 0V2.707l1.146 1.147a.5.5 0 1 0 .708-.708l-2.5-2.5zM11.5 6a.5.5 0 0 1 .5.5v6.793l1.146-1.147a.5.5 0 0 1 .708.708l-2.5 2.5a.5.5 0 0 1-.708 0l-2.5-2.5a.5.5 0 1 1 .708-.708L10.5 13.293V6.5a.5.5 0 0 1 .5-.5z"
        fill="currentColor"
      />
    </svg>
  );
...
export const SortSettingsIcon = ({ size = 16 }: { size?: number }) => {
  return (
    <svg
      height={size}
      strokeLinejoin="round"
    ...
    >
      <path
        d="M1.33325 12H5.99992V13.3333H1.33325V12ZM1.33325 7.33333H7.33325V8.66666H1.33325V7.33333ZM1.33325 2.66666H14.6666V4H1.33325V2.66666ZM13.7826 8.6834L14.5533 8.42266L15.22 9.57733L14.6093 10.1141C14.6469 10.2924 14.6666 10.4772 14.6666 10.6667C14.6666 10.8561 14.6469 11.0409 14.6093 11.2193L15.22 11.756L14.5533 12.9107L13.7826 12.6499C13.5089 12.8961 13.1841 13.0863 12.826 13.2029L12.6666 14H11.3333L11.1739 13.2029C10.8157 13.0863 10.4909 12.8961 10.2173 12.6499L9.44652 12.9107L8.77985 11.756L9.39059 11.2193C9.35299 11.0409 9.33325 10.8561 9.33325 10.6667C9.33325 10.4772 9.35299 10.2924 9.39059 10.1141L8.77985 9.57733L9.44652 8.42266L10.2173 8.6834C10.4909 8.43726 10.8157 8.247 11.1739 8.1304L11.3333 7.33333H12.6666L12.826 8.1304C13.1841 8.247 13.5089 8.43726 13.7826 8.6834ZM11.9999 11.3333C12.3681 11.3333 12.6666 11.0349 12.6666 10.6667C12.6666 10.2985 12.3681 10 11.9999 10C11.6317 10 11.3333 10.2985 11.3333 10.6667C11.3333 11.0349 11.6317 11.3333 11.9999 11.3333Z"
        fill="currentColor"
      />
    </svg>
  );
