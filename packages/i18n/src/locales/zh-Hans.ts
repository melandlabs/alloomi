const zhHans = {
  ...
  insightDocument: {
    ...
    uploadFailed: "上传失败",
    unsupportedFileType:
      "不支持的文件类型。请上传 PDF、Word、Excel、PowerPoint、文本或图片文件。",
    fileTooLarge: "文件太大。最大支持 10MB。",
    dropFilesHere: "拖放文件到这里上传",
    supportedFormats: "PDF, Word, Excel, PowerPoint, 文本, 图片",
  },
  ...
  auth: {
    ...
    feishuDes:
      "使用 App ID 和 App Secret 通过 WebSocket 长连接飞书，与 Alloomi 对话。",
    feishuTitle: "连接飞书",
    feishuDescription:
      "在飞书开放平台创建企业自建应用并开启机器人能力，选择「使用长连接接收事件」并订阅 im.message.receive_v1，将凭证填入下方即可与 Alloomi 对话。",
    feishuAppId: "App ID",
    feishuAppSecret: "App Secret",
    feishuDisplayName: "显示名称（可选）",
    feishuDisplayNamePlaceholder: "我的飞书",
    feishuConnect: "连接飞书",
    feishuGuide: "前往飞书开放平台创建/管理机器人",
    feishuOpenPlatform: "前往飞书开放平台",
    feishuConnectSuccess: "飞书已连接",
    feishuConnectRestartTitle: "飞书连接成功",
    feishuConnectRestartDescTauri:
      "为使飞书消息监听稳定生效，请完全退出并重新启动 Alloomi 桌面客户端",
    ...
    feishuSteps1Link: "飞书开放平台",
    feishuSteps1After: " ，创建企业自建应用",
    feishuSteps2: "在「凭证与基础信息」中获取 App ID、App Secret",
    feishuSteps3: "在配置中填写上述 App ID 和 App Secret，点击「连接飞书」按钮",
    feishuSteps4: "重启 Alloomi",
    feishuSteps5: "回到飞书开放平台，在「能力」中启用 机器人",
    feishuSteps6:
  ...
  insightPreferences: {
    ...
    loading: "正在载入偏好设置…",
    languageLabel: "回复语言",
    languageDescription: "Alloomi 生成内容和建议时使用的语言",
  ...
  chat: {
    ...
    unsupportedFilesWarning:
      "以下文件类型暂不支持发送给 AI: {{files}}。已自动过滤，仅发送图片附件。",
    dropFilesHere: "拖放文件到这里",
    fileDropArea: "文件拖放区域",
    supportedFileTypes: "支持图片和文档（PDF、DOC、PPT、TXT、Markdown）",
    uploadingInProgress: "请等待文件上传完成",
    alreadyRunning: "请等待当前回复完成后再继续。",
    documentUploaded: "文档 '{{name}}' 已添加到策略记忆",
    ...
    addFileFromWorkspace: "从空间内添加文件",
    uploadFileFromLocal: "从本地上传文件",
    categoryEvent: "事件",
  ...
  agent: {
    ...
    panels: {
      ...
      files: {
        ...
        supportedFormats: "PDF、Word、Excel、PowerPoint、文本、Markdown、图片",
        fileDropArea: "文件拖放区域",
      },
      workspacePanel: {
        title: "库",
    ...
    hub: {
      ...
      steps: {
        ...
        firstChat: {
          ...
          desc: "不只在 App 里——\n你现在可以通过 Telegram、QQ、飞书、iMessage、WhatsApp\n直接和你的 Alloomi 对话。\n随时提问、随时追踪，用你最顺手的工具就够了。",
